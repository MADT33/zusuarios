		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MiniSap",
									"targetURL": "#MiniSapproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MiniSapproject1-display": {
								"semanticObject": "MiniSapproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MiniSap.project1",
									"url": sap.ui.require.toUrl("MiniSap/project1")
								}
							}
						}
					}
